...
for i in range(1,10000):
    ...
    for x in range(0,51):
        ...
        #Numbers like 4994 are themselves Lychrel numbers.
        #i.e., we don't count "0 iterations" of reverse&add as a solution.
        currNum += int(str(currNum)[::-1])

        if isPalindrome(str(currNum)):
            lychrel = False
            break

    if lychrel:
        #print("Couldn't turn "+str(i)+" into a palindrome ("+str(currNum)+") after "+str(x)+" iterations of reverse & add")
